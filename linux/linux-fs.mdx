...
- **Primäre Partitionen:** Dies sind eigenständige Partitionen, die direkt auf der Festplatte erstellt werden können. Ein MBR (Master Boot Record) unterstützt bis zu vier primäre Partitionen oder drei primäre Partitionen und eine erweiterte Partition.
